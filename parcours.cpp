...
Parcours::Parcours() {
	...
	//-----------------Création Des Dénivelés--------------------------------------------------------------------------------------------
	for (int i = 0; i < nombreEtapes; i++) {
		denivele.push_back(rand() % 101 - 50);
	}
	//-----------------Création Des Points De Ravitaillement--------------------------------------------------------------------------------------------
	for (int i = 0; i < 8; i++) {
...
void Parcours::course(Coureur &joueur){
	...
	float tempo;
	for (int i = 0; i < nombreEtapes; i++) {
		//-----------------Calcul De La Vitesse Avec Réduction Des Pentes-------------------------------------------------------------------------------
		Pair = rand() % 3 - 1;
		vVent = (rand() % 26 + 75) / 10;
		...
		while (distance < etapes[i]) {
			...
			temps++;
			//--------------HYDRATATION----------------------------------------------------------------------------------------------------
			float nice = joueur.getHydratation() - 0.139;
...
//--------------------------------Afficher Course d'Une Seule Personne---------------------------------------------------------------
...
//--------------------------------Fin Affichage Course Personne Seule----------------------------------------------
